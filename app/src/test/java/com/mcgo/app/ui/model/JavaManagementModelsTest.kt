...
class JavaManagementModelsTest {
    ...
    fun defaultJavaManagementState_listsOnlyProvisionableManagedJreVersionsForMinecraft() {
        ...
        assertThat(state.runtimeOptions.map { it.primaryActionLabel }).containsExactly("下载安装", "下载安装", "下载安装", "下载安装")
        ...
        assertThat(state.runtimeOptions.filter { it.onlineInstallAvailable }.map { it.majorVersion }).containsExactly(8, 11, 17, 21).inOrder()
