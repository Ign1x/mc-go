...
class MCGoEditPageDesignContractTest {
    ...
    fun bottomNavigationUsesFloatingTranslucentGlassMenu() {
        ...
        assertThat(bottomMenu).contains("containerGradient")
        assertThat(bottomMenu).contains("Modifier.matchParentSize()")
        assertThat(bottomMenu).contains("padding(horizontal = 18.dp)")
        assertThat(bottomMenu).contains("padding(top = 0.dp, bottom = 12.dp)")
