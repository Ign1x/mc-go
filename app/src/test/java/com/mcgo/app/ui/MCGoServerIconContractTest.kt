...
class MCGoServerIconContractTest {
    ...
    private val iconStorageSource: String = String(Files.readAllBytes(projectRoot().resolve("app/src/main/java/com/mcgo/app/server/ManagedServerIconStorage.kt")))
    ...
    fun serverModelStoreRuntimeAndListCard_preserveAndRenderCustomServerIcon() {
        ...
        assertThat(runtimeSource).doesNotContain("fun writeManagedServerIcon(")
        assertThat(runtimeSource).doesNotContain("fun managedPaperServerIconFile(")
        assertThat(runtimeSource).doesNotContain("server-icon.png")
        assertThat(iconStorageSource).contains("private const val ManagedServerIconFileName = \"server-icon.png\"")
        assertThat(iconStorageSource).contains("fun writeManagedServerIcon(")
        assertThat(iconStorageSource).contains("fun managedPaperServerIconFile(")
        assertThat(iconStorageSource).contains("fun deleteManagedServerIcon(")
        assertThat(iconStorageSource).contains("StandardCopyOption.ATOMIC_MOVE")
        assertThat(iconUiSource).contains("fun ServerAvatar(")
